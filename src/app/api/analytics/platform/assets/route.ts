/**
 * Platform Assets Analytics API Route
 * 
 * GET /api/analytics/platform/assets
 * 
 * Provides upload trends and popular asset types for platform administrators.
 * ADMIN ONLY endpoint.
 */
...
import { PlatformAssetsAnalyticsService } from '@/modules/analytics/services/platform-assets-analytics.service';
...
/**
 * GET handler - Fetch platform asset analytics
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const { startDate, endDate, granularity, assetType, projectId, status } = validationResult.data;
    ...
    // Initialize service
    const analyticsService = new PlatformAssetsAnalyticsService(prisma, redis);
    ...
    console.error('[Platform Assets Analytics] Error:', error);
