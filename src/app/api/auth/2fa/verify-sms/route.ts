 ...
 * 
 * This endpoint validates the one-time password sent via SMS
 * and completes the authentication process if successful.
 */
...
export async function POST(req: NextRequest) {
  try {
    ...
    console.error('[2FA Verify SMS] Error:', error);
