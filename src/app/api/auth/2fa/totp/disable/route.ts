 ...
 * Disables TOTP (authenticator) two-factor authentication for the authenticated user
 * Requires password verification and optionally a TOTP code for enhanced security
 */
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Note: Email notification for 2FA disabled can be implemented when
